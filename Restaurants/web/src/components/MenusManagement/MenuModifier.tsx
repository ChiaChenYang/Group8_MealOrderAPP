...
export default function MenuModifier({
  setMenuList,
  selectedMenu,
}: MenuModifierProps) {
  ...
  const handleSave = () => {
    ...
    setMenuList((prevMenuList) =>
      prevMenuList.map((menu) =>
        menu.menuId === menuData.menuId ? menuData : menu,
      ),
    );
  };
                ...
                <Accordion key={item.id}>
                  ...
                  <AccordionDetails>
                    <SingleItem
                      item={item}
                      setItem={(newItem) =>
                        handleModifyItem(category.categoryId, item.id, newItem)
                      }
                    />
                  </AccordionDetails>
                </Accordion>

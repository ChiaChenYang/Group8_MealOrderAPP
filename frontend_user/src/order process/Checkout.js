    ...
    <div>
      ...
      <div>
        <p style={{ marginTop: "10px", marginLeft: "10px", fontSize: "20px" }}>
          ...
          <p style={{ fontSize: "15px", marginLeft: "10px" }}>{checking.prepare_time}~{checking.prepare_time+10} min</p>
        ...
        <p style={{ fontSize: "20px", margin: "10px 10px" }}>
          ...
          <div style={{ marginLeft: "-23px", borderBottom: "2px solid gray", paddingBottom: "10px", width: "450px" }}>
          {checking.type ? <TimePicker /> : <TimePicker2 />}
      </div>

      ...
      <CustomTabPanel value={value} index={0}>
        <div style={{ position: "absolute", left: 0 }}>
          <div style={{ height: "190px" }}>
            ...
            {menu.menu_lunch.main_dish &&
              Object.values(menu.menu_lunch.main_dish).map((dish, index) => (
                <Link
                  to={`/${userId}/restaurant/${menu.id}/${index}/${dish.name}`}
                  key={dish.name}
          ...
          >
            ...
            {menu.menu_lunch.drinks &&
              Object.values(menu.menu_lunch.drinks).map((dish, index) => (
                <Link
                  to={`/${userId}/restaurant/${menu.id}/${index}/${dish.name}`}
                  key={dish.name}
                  style={{ textDecoration: "none", color: "inherit" }}

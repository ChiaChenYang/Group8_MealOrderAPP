...
function Checkout() {
  ...
  return (
    <div>
        ...
        <div>
            <p style={{marginTop:"10px",marginLeft:"10px",fontSize:"20px"}}><strong>{restaurant_information.name}</strong><scan style={{fontSize:"15px",marginLeft:"150px"}}>{restaurant_information.location}</scan>
            <p  style={{fontSize:"15px"}}>{restaurant_information.prepare_time}</p></p>
            ...
            <p style={{marginLeft:"10px", borderBottom:"2px solid gray"}}>{order.name}
            <img src={order.image} alt={order.name} style={{marginLeft:"250px",width:"100px"}}/>
            <p>{order.quantity} <scan style={{marginLeft:"250px"}}>{order.price}</scan></p>
            </p>
            <div style={{marginLeft:"10px"}}>
            <p style={{fontSize:"20px"}}><strong>小計<scan style={{marginLeft:"250px"}}>{order.price}</scan></strong></p>

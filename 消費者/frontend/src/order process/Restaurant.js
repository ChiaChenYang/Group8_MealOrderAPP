      ...
      <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
        ...
        <div style={{borderRight:"2px solid gray",borderLeft:"2px solid gray",borderTop:"2px solid gray",flex: 1, display: 'flex', flexDirection: 'column', position: 'relative' }}>
            ...
            <div style={{position: 'absolute', top: '60px', left:'20px'}}>
                ...
                <p><StarIcon style={{ fontSize: '20px', color: '#F4B63D' }}/> {menu.evaluate} ({menu.comment}+)
                ...
                <p>
                    <NotificationsIcon style={{ fontSize: '20px', color: '#F4B63D' }}/>
                    <strong> 最新消息</strong>
                    <p style={{ marginLeft: '25px' }}>{menu.news}</p>
                </p>
                <div style={{marginLeft:"-20px",width:"100%"}}><BasicTabs /></div>
            </div>
        </div>
    </div>
    {console.log(id) /*this is the restaurant_id*/}
    </div>
  );
}

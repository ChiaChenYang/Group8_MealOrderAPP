    ...
    <Box sx={{width:'100%'}}>
      ...
      <ThemeProvider theme={theme}> 
        ...
        textColor="secondary" indicatorColor="secondary" >
          <Tab label={<div><p>午間時段<p style={{fontSize:"12px"}}>11:00-17:00</p></p></div>} {...a11yProps(0)} sx={{paddingLeft:'28px',paddingRight:'28px'}}/>
          <Tab label={<div><p>晚間時段<p style={{fontSize:"12px"}}>17:00-21:00</p></p></div>} {...a11yProps(1)} sx={{paddingLeft:'28px',paddingRight:'28px'}}/>
          <Tab label={<div><p>全日時段<p style={{fontSize:"12px"}}>11:00-21:00</p></p></div>} {...a11yProps(2)} sx={{paddingLeft:'28px',paddingRight:'28px'}}/>
        </Tabs>
        </ThemeProvider>
      </Box>

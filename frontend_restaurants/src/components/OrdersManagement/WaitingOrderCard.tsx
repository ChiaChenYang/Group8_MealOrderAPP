...
import { completeOrder } from '@/lib/api/orders/api';
...
function ModalBody({ order, theme, handleClose, setRefreshKey }: ModalBodyProps) {
...
export default function WaitingOrderCard({ order, setRefreshKey }: WaitingOrderCardProps) {
